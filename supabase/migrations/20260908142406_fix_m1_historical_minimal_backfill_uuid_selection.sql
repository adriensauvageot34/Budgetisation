...
begin
  ...
  select * into v_mutation from public.record_analytics_mutation(
    ...
    (select rule_version_id from public.minimal_baseline_rule_versions where household_id = p_household_id and backfill_plan_hash = p_plan_hash order by rule_version_id limit 1),
    date '2025-08-01',
    'global_reference',
