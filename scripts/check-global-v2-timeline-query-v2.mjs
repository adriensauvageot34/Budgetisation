...
const metaFor = (resource, resourceParams) => ({ contractVersion: query.globalV2QueryRegistry[resource].contractVersion, methodSignature: resource === "analysis_global_life_timeline" ? query.globalV2TimelineMethodForSchema("global-life-timeline@v2").methodSignature : planApi.globalV2QueryMethodSignature(resource), policyVersions: resource === "analysis_global_life_timeline" ? query.globalV2TimelineMethodForSchema("global-life-timeline@v2").policyVersions : query.globalV2QueryRegistry[resource].policyVersions, resourceInputHash: planApi.globalV2QueryResourceInputHash({ resource, scope: normalizedScope, params: resourceParams, dependencies }) });
