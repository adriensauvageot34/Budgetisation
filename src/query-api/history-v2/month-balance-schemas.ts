...
export const categoryDetailReadModelSchema = monthlySchema<CategoryDetailReadModel>(queryResourceKeys.historyCategoryDetail, ["category", "typicalComposition", "explanation", "frequencyTicket", "merchantAndPurchaseDrivers", "lifecycleBadges"], "CategoryDetailReadModel");
