...
export type QueryReadModelSources = {
  ...
  readonly readHistoryMonthOverview: QueryReadModelSource<"history_month_overview">;
  readonly readHistoryMonthBalanceSummary: QueryReadModelSource<"history_month_balance_summary">;
  readonly readHistoryBankEconomyBridge: QueryReadModelSource<"history_bank_economy_bridge">;
  readonly readHistoryMonthCategories: QueryReadModelSource<"history_month_categories">;
  readonly readHistoryCategoryDetail: QueryReadModelSource<"history_category_detail">;
  readonly readHistoryMonthSpendingNature: QueryReadModelSource<"history_month_spending_nature">;
  readonly readHistorySpendingSegmentDetail: QueryReadModelSource<"history_spending_segment_detail">;
  readonly readHistoryMinimalPreview: QueryReadModelSource<"history_minimal_preview">;
  readonly readHistoryMonthLifeMoney: QueryReadModelSource<"history_month_life_money">;
  readonly readHistoryActivityDetail: QueryReadModelSource<"history_activity_detail">;
  readonly readHistoryMomentDetail: QueryReadModelSource<"history_moment_detail">;
  readonly readHistoryPlaceDetail: QueryReadModelSource<"history_place_detail">;
