...
export {
  ...
  type AnnualMobilityNarrativeCandidate,
  type MobilityNarrativeDestination,
  type MobilityNarrativeMetricTotals,
  type MobilityPlaceRole,
  type MobilityRoutinePattern,
  type MobilitySemanticFamily,
  type MobilityUsageBand,
  type MonthlyMobilityContextOnly,
  type MonthlyMobilityNarrative,
  type MonthlyMobilityNarrativeContextInput,
  type MonthlyMobilityNarrativeLegInput,
  type MonthlyMobilityNarrativeResult,
  type MonthlyMobilityNarrativeTripInput,
  type MonthlyMobilityPartitionAssignment,
  type MonthlyMobilityPlaceAuthority,
  type MonthlyMobilityRoutineGroup,
  type MonthlyMobilitySuppressedRemainder,
  type MonthlyMobilityTripSummary,
