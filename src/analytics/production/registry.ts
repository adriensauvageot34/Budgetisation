...
import { MINIMAL_MONTH_METHOD_VERSION } from "../baseline";
import type {
  ActiveMetricId,
  MetricRegistryEntry,
} from "./types";
...
export const metricMethodVersions = {
  ...
  minimal_month_cost: MINIMAL_MONTH_METHOD_VERSION,
  ...
  fixed_variable_amount: parseMethodVersion("fixed_variable_amount@v1"),
...
export const metricRegistry = {
  ...
  minimal_month_cost: {
    metricId: parseMetricId("minimal_month_cost"),
    semanticName: "Coût du mois minimal réaliste",
    grain: ["reference_month"],
    sourceFact: [],
    productionStrategy: "minimal_month",
    dateBasis: "observation_window",
    dimensions: ["month"],
    allowedFilters: [],
    monetaryBasis: "estimated_cost",
    supportPolicy: { kind: "optional", unit: "month" },
    availabilityRules: ["method_defined"],
    additivity: { kind: "non_additive", recomputeOnTargetGroup: true },
    provenanceRule: "derived",
    comparisonCapabilities: ["typical_vs_minimal", "actual_vs_adjusted_minimal"],
    methodVersion: metricMethodVersions.minimal_month_cost,
    unit: "EUR/month",
    outputKind: "money",
    allowedTimeKinds: ["month"],
  },
  ...
  fixed_variable_amount: {
    metricId: parseMetricId("fixed_variable_amount"),
    semanticName: "Montant net par comportement fixe ou variable",
    grain: ["canonical_economic_component"],
    sourceFact: ["fct_economic_component"],
    productionStrategy: "sum_economic_net",
    dateBasis: "economic_timing",
    ...
    provenanceRule: "observed",
    comparisonCapabilities: ["same_metric"],
    methodVersion: metricMethodVersions.fixed_variable_amount,
    unit: "EUR",
    outputKind: "money",
    allowedTimeKinds: ["month", "global"],
  },
  ...
  activity_causal_cost: {
    ...
    semanticName: "Coût causal économique net de l’activité",
    grain: ["activity_occurrence_cost"],
    sourceFact: ["fct_activity_occurrence_cost"],
    productionStrategy: "sum_activity_causal_cost",
    dateBasis: "activity_occurrence_date",
    dimensions: ["activity", "month"],
    allowedFilters: ["activity"],
    monetaryBasis: "economic_net",
    supportPolicy: { kind: "activity_causal_cost", unit: "occurrence" },
    availabilityRules: ["source_availability"],
    additivity: { kind: "conditionally_additive", condition: "canonical_component_allocation" },
    provenanceRule: "derived",
    comparisonCapabilities: ["same_metric"],
  ...
  activity_causal_median_cost_per_occurrence: {
    metricId: parseMetricId("activity_causal_median_cost_per_occurrence"),
    semanticName: "Coût causal économique net médian par occurrence",
    grain: ["activity_occurrence_cost"],
    sourceFact: ["fct_activity_occurrence_cost"],
    productionStrategy: "median_activity_causal_cost",
    dateBasis: "activity_occurrence_date",
    dimensions: ["activity", "month"],
    allowedFilters: ["activity"],
    monetaryBasis: "economic_net",
    ...
    provenanceRule: "derived",
    comparisonCapabilities: ["same_metric"],
    methodVersion: metricMethodVersions.activity_causal_median_cost_per_occurrence,
    unit: "EUR/occurrence",
    outputKind: "money",
    allowedTimeKinds: ["month"],
