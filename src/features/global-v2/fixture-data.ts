...
function backgroundRhythmsFixture(): GlobalBackgroundRhythmsReadModel {
  ...
  return parseGlobalBackgroundRhythmsReadModel({
    kind: "global_background_rhythms", schemaVersion: "global-background-rhythms@v2", resource: "analysis_global_background_rhythms", moduleKey: "RHYTHM",
    period: { startMonth: "2025-08", endMonth: "2026-07" },
    food: {
      annual: { courses: "5275.88", restaurants: "1303.53", deliveries: "159.17", total: "6738.58", nonGroceryAmount: "1462.70", nonGroceryShare: "0.217067", moneyQuality: [0, "6738.58", "6738.58"], groceryBehavior: { knownCostOccurrenceCount: 87, eligibleMonthCount: 9, historicalComparisonGate: "AVAILABLE", thresholds: { p25: "18.29", p75: "51.99" } }, restaurantBehavior: { paymentCount: 100, semanticOccurrenceCount: 158, knownCostOccurrenceCount: 28, occurrenceCoverage: "0.75", linkedFinanceAmountCoverage: "0.82", medianCost: { status: "KNOWN", value: "18.40" } }, deliveryBehavior: { paymentCount: 8, countLabel: "paiements de livraison", occurrenceStatus: "UNKNOWN", reasonCode: "NO_DELIVERY_OCCURRENCE_AUTHORITY" } },
      months: foodMonths,
      benefitCoverage: { status: "NOT_OBSERVED", startMonth: "2025-08", endMonth: "2026-07", exceptions: [] }, monthlyBenefitFunding: [],
      constants: { financialAmountAvailable: true, deliveryCountLabel: "paiements de livraison", deliveryOccurrenceStatus: "UNKNOWN", deliveryReasonCode: "NO_DELIVERY_OCCURRENCE_AUTHORITY", monetaryAuthority: "FINANCE_CANONICAL", deliveryOccurrenceKnowledge: "UNKNOWN" },
      annotations: [
