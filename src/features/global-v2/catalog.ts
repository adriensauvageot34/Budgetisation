...
export const globalModulePresentations = Object.freeze([
  ...
  { key: "CATEGORIES_NEEDS", resource: "analysis_global_categories_needs", expandedResource: "analysis_global_categories_needs_expanded", detailResource: "analysis_global_category_need_detail", order: 2, shortLabel: "Catégories", title: "Où va notre argent ?", eyebrow: "", description: "Les postes qui structurent nos dépenses." },
  ...
  { key: "RHYTHM", resource: "analysis_global_rhythm", expandedResource: "analysis_global_rhythm_expanded", detailResource: "analysis_global_routine_detail", order: 4, shortLabel: "Vie & dépenses", title: "Notre vie derrière nos dépenses", eyebrow: "", description: "Ce que certaines habitudes et certains moments ont réellement changé ou contextualisé dans nos dépenses." },
