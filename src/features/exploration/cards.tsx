...
export function MomentCard({
  ...
  return (
    <CardSurface variant="outlined" className={styles.momentCard} action={{ kind: "callback", onAction: () => navigation.push({ kind: "moment", id: momentId }) }} ariaLabel={`Explorer le Moment ${title}`}>
...
export function PlaceCard({
  ...
  return (
    <CardSurface variant="outlined" className={styles.placeCard} action={{ kind: "callback", onAction: () => navigation.push({ kind: "place", id: placeId }) }} ariaLabel={`Explorer le lieu ${label}`}>
...
export function MerchantCard({
  ...
  return (
    <CardSurface variant="outlined" className={styles.merchantCard} action={{ kind: "callback", onAction: () => navigation.push({ kind: "merchant", id: merchantId }) }} ariaLabel={`Explorer le marchand ${label}`}>
...
export function PersonaCard({
  ...
  return (
    <CardSurface variant="outlined" className={styles.personaCard} action={{ kind: "callback", onAction: () => navigation.push({ kind: "persona", id: personaId }) }} ariaLabel={`Explorer ${title}`}>
...
export function LifeEventCard({
  ...
  return (
    <CardSurface variant="outlined" className={styles.lifeEventCard} action={{ kind: "callback", onAction: () => navigation.push({ kind: "life_event", id: lifeEventId }) }} ariaLabel={`Explorer l’événement ${title}`}>
...
export function OperationPreviewCard({
  ...
  return (
    <CardSurface variant="outlined" className={styles.operationPreview} action={{ kind: "callback", onAction: () => navigation.push({ kind: "operation", id: operation.operationId }) }} ariaLabel={`Ouvrir la preuve bancaire ${operation.label}`}>
